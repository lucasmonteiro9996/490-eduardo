...
function formatValid(valid = '') {
  if (!valid) return '1 2 / 2 4'
  const [mm = '00', yy = '00'] = valid.split('/')
    ...
    <div className={styles.flipCard}>
      <div className={styles.flipCardInner}>
        <div className={styles.flipCardFront}>
          ...
          <svg className={styles.chip} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 50 50">
            <image width="50" height="50" href={chipImage} />
          </svg>
