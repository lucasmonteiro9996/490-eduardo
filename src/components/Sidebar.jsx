  ...
  return (
    <aside className={`${styles.sidebar} ${collapsed ? styles.collapsed : ''}`}>
      ...
      <div className={styles.logoArea}>
        ...
        <button className={styles.collapseBtn} onClick={() => setCollapsed(v => !v)} title={collapsed ? 'Expandir' : 'Recolher'}>
      ...
      <div className={styles.userArea}>
        ...
        {!collapsed && (
          <div className={styles.userInfo}>
            <span className={styles.userName}>Lucas C.</span>
        ...
        {!collapsed && (
          <button className={styles.logoutBtn} onClick={() => navigate('/')} title="Sair">
